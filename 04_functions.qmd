...
You can download this .qmd file from [here](https://github.com/proback/264_fall_2024/blob/main/04_functions.qmd).  Just hit the Download Raw File button.

### Introduction (from Ch 25 of MDSR)
