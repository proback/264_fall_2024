...
In the code and output below, we present a set of practice exercises in converting from the tidyverse to SQL.  This code can be downloaded [here](https://github.com/proback/264_fall_2024/blob/main/11_SQL.qmd).
