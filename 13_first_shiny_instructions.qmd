...
a) Click "File" > "New File" > "R Markdown" (Note: although quarto works nicely with interactive apps, we will use Rmarkdown files for consistency with the past projects that you might want to learn from.)
...
- [14a_first_shiny_key.Rmd](https://github.com/proback/264_fall_2024/blob/main/14a_first_shiny_key.Rmd)

- [14_AER_Shiny.Rmd](https://github.com/proback/264_fall_2024/blob/main/14_AER_Shiny.Rmd)

- [15_first_Shiny_flexdash.Rmd](https://github.com/proback/264_fall_2024/blob/main/15_first_Shiny_flexdash.Rmd)

We will also use these folders as well:

- [AER_app](https://github.com/proback/264_fall_2024/blob/main/AER_app)

- [Ames example](https://github.com/proback/264_fall_2024/blob/main/Ames example)
